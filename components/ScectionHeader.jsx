...
const SectionHeader = ({children, title}) => {
    ...
    return (
        <section className="container mx-auto">
            <header className="w-full flex flex-col md:flex-row justify-between items-center py-2 mt-4">
                <h1 className="text-2xl font-bold  text-pri-dark">{title}</h1>
                <div className="flex justify-between">
                    <div className="w-full flex-1 bg-gradient-to-r from-dark via-white to-pri flex flex-row rounded-md border overflow-hidden border-gray-200 items-center">
                    ...
                    <button className="px-10 py-2 text-sm focus:outline-none rounded-md text-white uppercase ml-1 md:ml-5 border border-gray-200 bg-pri hover:bg-opacity-90">
                        View All
                    </button>
                </div>
            </header>
