        ...
        <div className="wrapper bg-white shadow-md rounded-md mt-5">
            <div className="w-full p-2">
                <div className="w-full flex justify-evenly border-b py-3 border-gray-200">
                    <h2 className="text-gray-500 cursor-pointer"><span className="border-b-2 text-sec border-sec pb capitalize">Products</span></h2>
                    <h2 className="text-gray-500 cursor-pointer"><span className="hover:border-b-2 hover:text-sec border-sec pb capitalize">Shops</span></h2>
                </div>
